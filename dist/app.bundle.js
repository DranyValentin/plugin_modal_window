...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "3c2cc4b8e42c196d1f20";
  ...
  constructor(name) {
    ...
    */
    ...
    this.addActionToButton = (idButton, action) => {
      if (typeof idButton != 'string' && typeof action != 'function') return;
...
popup.create().add({
  ...
  id: "btn_popup_ok",
  class: "popup_btn_ok"
}).addButtonClose().addActionToButton('btn_popup_ok', () => {
  console.log(popup);
}); //.show()
